...
{{--           <li class="nav-item"><a class="nav-link" href="{{ url('menu-items') }}"><i class="nav-icon icon-graduation"></i> {{ trans('admin.menu-item.title') }}</a></li>--}}
           <li class="nav-item"><a class="nav-link" href="{{ url('ph-classes') }}"><i class="nav-icon icon-globe"></i> {{ trans('admin.ph-class.title') }}</a></li>
           <li class="nav-item"><a class="nav-link" href="{{ url('ph-classes') }}"><i class="nav-icon icon-book-open"></i> {{ trans('admin.ph-class.title') }}</a></li>
