            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('attendances/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.attendance.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block table-responsive">
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'enrollment_id'">{{ trans('admin.attendance.columns.enrollment_id') }}</th>
                                        <th is='sortable' :column="'roll_call_id'">{{ trans('admin.attendance.columns.roll_call_id') }}</th>
                                        <th is='sortable' :column="'attendance_status_id'">{{ trans('admin.attendance.columns.attendance_status_id') }}</th>
                                    ...
                                    <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="7">
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3" @click="bulkDelete('https://csm.strathmore.edu/ph/attendances/bulk-destroy')">{{ trans('savannabits/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>@{{ item.roll_call_id }}</td>
                                        <td>@{{ item.attendance_status_id }}</td>
                                        <td>@{{ item.comment }}</td>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('attendances/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.attendance.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
