<b-modal
    scrollable
    @ok.prevent="submitChildForm" ok-title="Update" cancel-title="Close" v-cloak size="xl"
    ref="childEditModal" v-if="form && form.id">
    <template v-slot:modal-title>
        <strong>Edit @{{ form.first_name }} @{{ form.last_name }}</strong>
    </template>
