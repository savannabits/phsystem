...
class FillWebPermissionsForRelationshipType extends Migration
{
    /**
    ...
    protected $group;
    /**
     * FillWebPermissionsForRelationshipType constructor.
     */
    public function __construct()
    {
        $this->guardName = config('auth.defaults.guard');
        $explode = explode(".",'relationship-type');
        ...
        $permissions = collect([
            ...
            'relationship-type.show',
            'relationship-type.edit',
            'relationship-type.delete',
                            'relationship-type.bulk-delete',
                    ]);
