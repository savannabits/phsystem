...
class FillWebPermissionsForResourceType extends Migration
{
    /**
    ...
    protected $group;
    /**
     * FillWebPermissionsForResourceType constructor.
     */
    public function __construct()
    {
        $this->guardName = config('auth.defaults.guard');
        $explode = explode(".",'resource-type');
