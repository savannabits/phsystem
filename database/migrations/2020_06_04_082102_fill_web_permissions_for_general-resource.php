...
class FillWebPermissionsForGeneralResource extends Migration
{
    /**
    ...
    protected $group;
    /**
     * FillWebPermissionsForGeneralResource constructor.
     */
    public function __construct()
    {
        $this->guardName = config('auth.defaults.guard');
        $explode = explode(".",'general-resource');
        $this->group = isset($explode[1]) ? $explode[1] : $explode[0];

        $permissions = collect([
            'general-resource',
            'general-resource.index',
            'general-resource.create',
            'general-resource.show',
            'general-resource.edit',
            'general-resource.delete',
                            'general-resource.bulk-delete',
                    ]);
