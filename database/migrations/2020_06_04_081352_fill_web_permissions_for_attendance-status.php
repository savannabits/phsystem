...
class FillWebPermissionsForAttendanceStatus extends Migration
{
    /**
    ...
    protected $group;
    /**
     * FillWebPermissionsForAttendanceStatus constructor.
     */
    public function __construct()
    {
        $this->guardName = config('auth.defaults.guard');
        $explode = explode(".",'attendance-status');
