...
class FillWebPermissionsForLessonResource extends Migration
{
    /**
    ...
    protected $group;
    /**
     * FillWebPermissionsForLessonResource constructor.
     */
    public function __construct()
    {
        $this->guardName = config('auth.defaults.guard');
        $explode = explode(".",'lesson-resource');
        $this->group = isset($explode[1]) ? $explode[1] : $explode[0];

        $permissions = collect([
            'lesson-resource',
            'lesson-resource.index',
            'lesson-resource.create',
            'lesson-resource.show',
            'lesson-resource.edit',
            'lesson-resource.delete',
                            'lesson-resource.bulk-delete',
                    ]);
