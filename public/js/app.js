...
/* harmony import */ var _web_app_components_bootstrap__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./web/app-components/bootstrap */ "./resources/js/web/app-components/bootstrap.js");
/* harmony import */ var _frontend_components__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./frontend-components */ "./resources/js/frontend-components/index.js");
/**
...
vue__WEBPACK_IMPORTED_MODULE_8___default.a.component('multiselect', function () {
...
vue__WEBPACK_IMPORTED_MODULE_8___default.a.component('typeahead', function () {
...
vue__WEBPACK_IMPORTED_MODULE_8___default.a.use(vee_validate__WEBPACK_IMPORTED_MODULE_3__["default"], {
  strict: true
});
vue__WEBPACK_IMPORTED_MODULE_8___default.a.component('datetime', function () {
...
vue__WEBPACK_IMPORTED_MODULE_8___default.a.use(bootstrap_vue__WEBPACK_IMPORTED_MODULE_7__["default"]);
vue__WEBPACK_IMPORTED_MODULE_8___default.a.use(bootstrap_vue__WEBPACK_IMPORTED_MODULE_7__["BootstrapVueIcons"]); // Vue.use(VueQuillEditor);

vue__WEBPACK_IMPORTED_MODULE_8___default.a.use(vue_notification__WEBPACK_IMPORTED_MODULE_2___default.a);
vue__WEBPACK_IMPORTED_MODULE_8___default.a.use(vue_cookie__WEBPACK_IMPORTED_MODULE_5___default.a);
vue__WEBPACK_IMPORTED_MODULE_8___default.a.use(vue2_filters__WEBPACK_IMPORTED_MODULE_1___default.a);
vue__WEBPACK_IMPORTED_MODULE_8___default.a.use(vue_loading_overlay__WEBPACK_IMPORTED_MODULE_9___default.a, {
  // props
  color: 'green',
  loader: 'dots'
});
...
window.axios.defaults.baseURL = "".concat((_window$Laravel = window.Laravel) === null || _window$Laravel === void 0 ? void 0 : _window$Laravel.baseUrl);
/**
...
var baseUrl = document.head.querySelector('meta[name="app-base-url"]');
var apiPrefix = document.head.querySelector('meta[name="api-prefix"]');
...
if (baseUrl) {
  ...
  window.axios.defaults.baseURL = "".concat(baseUrl.content);
...
/***/ "./resources/js/web/app-components/Form/AppUpload.js":
/*!***********************************************************!*\
  !*** ./resources/js/web/app-components/Form/AppUpload.js ***!
  \***********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _base_BaseUpload__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base/BaseUpload */ "./resources/js/web/app-components/Form/base/BaseUpload.js");
/* harmony import */ var _base_BaseUpload__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_base_BaseUpload__WEBPACK_IMPORTED_MODULE_0__);

Vue.component('media-upload', {
  mixins: [_base_BaseUpload__WEBPACK_IMPORTED_MODULE_0___default.a],
  props: ["baseUrl"]
});

/***/ }),

/***/ "./resources/js/web/app-components/Form/RestaurantSwitcher.js":
/*!********************************************************************!*\
  !*** ./resources/js/web/app-components/Form/RestaurantSwitcher.js ***!
  \********************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _AppForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AppForm */ "./resources/js/web/app-components/Form/AppForm.js");
...
Vue.component('restaurant-switcher', {
  mixins: [_AppForm__WEBPACK_IMPORTED_MODULE_0__["default"]],
  props: [],
  data: function data() {
    return {
      form: {
  ...
  methods: {
    backupRestaurant: function backupRestaurant() {
      this.restaurant = _objectSpread({}, this.form.restaurant);
    },
    restoreRestaurant: function restoreRestaurant() {
      this.form.restaurant = _objectSpread({}, this.restaurant);
    },
    switchRestaurant: function switchRestaurant() {
      var _this = this;
      ...
      axios.put("/api/switch-restaurant", this.form).then(function (res) {
        _this.form.restaurant = res.data.payload;
        _this.restaurant = res.data.payload;
...
/***/ "./resources/js/web/app-components/Form/base/BaseUpload.js":
/*!*****************************************************************!*\
  !*** ./resources/js/web/app-components/Form/base/BaseUpload.js ***!
  \*****************************************************************/
/*! no static exports found */
...
var _vue2Dropzone = __webpack_require__(/*! vue2-dropzone */ "./node_modules/vue2-dropzone/dist/vue2-dropzone.js");
...
var BaseUpload = {
  ...
  methods: {
    ...
    onFileDelete: function onFileDelete(file, error, xhr) {
      var deletedFileIndex = _.findIndex(this.mutableUploadedImages, {
        url: file.url
      });
        ...
        if (_this.mutableUploadedImages) {
          _.each(_this.mutableUploadedImages, function (file, key) {
            _this.$refs[_this.collection].manuallyAddFile({
              ...
              size: file['size'],
              type: file['type'],
              url: "".concat(_this.baseUrl || '').concat(file['url'])
            }, "".concat(_this.baseUrl || '').concat(file['thumb_url']), false, false, {
...
/***/ "./resources/js/web/app-components/bootstrap.js":
/*!******************************************************!*\
  !*** ./resources/js/web/app-components/bootstrap.js ***!
  \******************************************************/
/*! no exports provided */
...
/* harmony import */ var craftable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! craftable */ "./node_modules/craftable/dist/index.js");
/* harmony import */ var craftable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(craftable__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Listing_AppListing__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Listing/AppListing */ "./resources/js/web/app-components/Listing/AppListing.js");
/* harmony import */ var _Form_AppUpload__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Form/AppUpload */ "./resources/js/web/app-components/Form/AppUpload.js");
/* harmony import */ var _Form_RestaurantSwitcher__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Form/RestaurantSwitcher */ "./resources/js/web/app-components/Form/RestaurantSwitcher.js");
...
module.exports = __webpack_require__(/*! /data/www/savbits/phsystem/resources/js/app.js */"./resources/js/app.js");
